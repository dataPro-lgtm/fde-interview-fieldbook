...
REQUIRED = {
    ...
    "data/calibration-scenarios.json",
    "data/content-parity.json",
    "data/learning-paths.json",
    "data/role-playbooks.json",
    "data/role-radar/2026-Q3.json",
    "data/sources.json",
    "data/source-archives/2026.json",
    "data/technology-baselines.json",
    "docs/en/interview-loop.md",
    "docs/en/answer-calibration.md",
    "docs/en/behavioral-field-leadership.md",
    "docs/en/coding-data-delivery.md",
    "docs/en/discovery.md",
    "docs/en/field-case-lab.md",
    "docs/en/field-operating-playbook.md",
    ...
    "docs/en/question-bank.md",
    "docs/en/study-plans.md",
    "docs/research/bilingual-maintenance.md",
    ...
    "docs/research/release-validation-0.8.md",
    "docs/research/release-validation-0.9.md",
    ...
    "interview-kits/rubrics/calibration-protocol.md",
    "interview-kits/rubrics/evidence-anchor-library.md",
    ...
    "interview-kits/worksheets/reviewer-calibration-record.md",
    "scripts/check_external_links.py",
    "scripts/summarize_calibration.py",
    "scripts/validate_calibration.py",
    "scripts/validate_learning_paths.py",
    "scripts/validate_parity_archive.py",
