...
这三个案例都是原创教学场景，不是任何公司的真实或泄露面试题。它们属于“讲解型案例”：适合学习完整推理，但答案和题目在同一页。如果你已经理解主线，想检验信息不完整时的现场反应，请改用[Field Case Lab](../../interview-kits/cases/README.md)，由同伴分轮释放证据。参考推演不是唯一解；重点是每个决策都有现实依据和失效边界。
...
完成讲解型案例后，至少选择一套[盲练案例](../../interview-kits/cases/README.md)。不要提前打开面试官手册和复盘；如果新证据出现后你的方案完全不变，需要检查自己是在坚持原则，还是没有真正更新判断。
